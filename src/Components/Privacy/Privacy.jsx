        ...
        <div className="policy mb-5 mx-auto bg-white md:px-5 md:py-10 md:mb-10">
          ...
          <ul className="list-disc list-inside">
            <li>
              <p>Qwarqo</p>
              <p>
                <a href="https://qwarqo.com/policy" className="text-blue-600 underline">https://qwarqo.com/policy</a>
              </p>
            </li>
          </ul>  

          <h2 className="text-xl font-semibold mt-4">Advertising Partners Privacy Policies</h2>  

          <p>
            You may consult this list to find the Privacy Policy for each of the advertising partners of <a href="https://rentalsuccess.netlify.app/" className="text-blue-600 underline">Renters Success</a>.
          </p>  

          <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on <a href="https://rentalsuccess.netlify.app/" className="text-blue-600 underline">Renters Success</a>, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.
          </p>  
          ...
          <h2 className="text-xl font-semibold mt-4">GDPR Data Protection Rights</h2>  
          ...
          <h2 className="text-xl font-semibold mt-4">Children's Information</h2>
          <p>
