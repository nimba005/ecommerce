...
const Terms = () => {
  return (
    <section>
      ...
      {/* Main Content */}
      <div className="flex flex-col max-w-screen-xl mx-auto px-2 md:my-0">
        ...
        <div className="policy mb-5 mx-auto bg-white md:px-5 md:py-10">
          ...
          <p>
            ...
            shall manage your use of our website, <a href="https://rentalsuccess.netlify.app/">Renters Success</a>.
          </p>
          <p>
          ...
          <p>
            ...
            Success express no representations or warranties, of any kind related
